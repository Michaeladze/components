...
var Input = function (_a) {
    // -------------------------------------------------------------------------------------------------------------------
    var _b, _c;
    var onClear = _a.onClear, _d = _a.debounce, debounce = _d === void 0 ? 300 : _d, _e = _a.search, search = _e === void 0 ? false : _e, floatLabel = _a.floatLabel, getValue = _a.getValue, _f = _a.size, size = _f === void 0 ? 'small' : _f, props = __rest(_a, ["onClear", "debounce", "search", "floatLabel", "getValue", "size"]);
    /** Ref */
    ...
    var _j = react_1.useState(search), showSearch = _j[0], setShowSearch = _j[1];
    /** Значение поля */
    var _k = react_1.useState(((_b = props.defaultValue) === null || _b === void 0 ? void 0 : _b.toString()) || ((_c = props.value) === null || _c === void 0 ? void 0 : _c.toString()) || ''), value = _k[0], setValue = _k[1];
    // -------------------------------------------------------------------------------------------------------------------
    ...
    /** Кнопка поиска и сброса */
    var searchButton = search && showSearch && (react_1.default.createElement("button", { className: 'rf-input__action rf-input__action-search' },
