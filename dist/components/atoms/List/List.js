...
var List = function (_a) {
    var list = _a.list;
    var onElementClick = function (e, handler) {
        e.stopPropagation();
        e.preventDefault();
        handler && handler();
        onClose && onClose();
    ...
    var listElementJSX = list &&
        list.map(function (li, i) {
            ...
            return (react_1.default.createElement("li", { className: 'rf-li', key: li.value || i },
                ...
                react_1.default.createElement("div", { className: "rf-list__element " + disabledClass + " " + separatedClass, onClick: function (e) { return onElementClick(e, li.handler); } }, li.label)));
        });
    // -------------------------------------------------------------------------------------------------------------------
