...
var Radio = function (_a) {
    ...
    var sizeClass = size === 'small' ? 'rf-radio--small' : '';
    return (react_1.default.createElement("label", { className: "rf-radio " + (props.className || '') + " " + (props.disabled ? 'disabled' : '') + " " + sizeClass, onMouseDown: onMouseDown, onMouseUp: onMouseUp },
