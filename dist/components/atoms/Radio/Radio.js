...
var Radio = function (_a) {
    ...
    return (react_1.default.createElement("label", { className: "rf-radio " + (props.className || '') + " " + (props.disabled ? 'disabled' : '') + " " + helpers_1.sizeClass[size], onMouseDown: onMouseDown, onMouseUp: onMouseUp },
