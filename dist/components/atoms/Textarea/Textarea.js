...
var Textarea = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "rf-textarea__wrapper " + props.className },
        react_1.default.createElement("textarea", __assign({}, props, { ref: textarea, rows: rows, className: "rf-textarea-field " + props.className, autoComplete: 'off' })),
        props.maxLength && props.maxLength > 0 && !props.disabled && (react_1.default.createElement("p", { className: 'rf-textarea__max-length' },
            value.length,
            " / ",
            props.maxLength))));
};
