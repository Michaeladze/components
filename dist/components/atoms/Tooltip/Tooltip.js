...
var TooltipContent = function (_a) {
    var _b;
    var rect = _a.rect, children = _a.children, position = _a.position, className = _a.className;
    ...
    return react_dom_1.createPortal(tooltip, div);
};
var Tooltip = function (_a) {
    ...
    var _e = react_1.useState(null), tooltipRect = _e[0], setTooltipRect = _e[1];
    ...
    return (react_1.default.createElement("div", { className: 'rf-tooltip', onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onClick: stopPropagation, onMouseUp: stopPropagation },
        children[0],
        tooltipRect && isVisible && (react_1.default.createElement(TooltipContent, { className: className, position: position, rect: tooltipRect }, children[1]))));
};
