...
var Chips = function (_a) {
    var items = _a.items, _b = _a.variant, variant = _b === void 0 ? 'neutral' : _b, _c = _a.size, size = _c === void 0 ? 'medium' : _c, onRemove = _a.onRemove, onClick = _a.onClick, className = _a.className, disabled = _a.disabled;
    ...
    var chips = items.map(function (e) { return (react_1.default.createElement("div", { className: "rf-chips__item " + helpers_1.variantClass[variant] + " " + helpers_1.sizeClass[size] + " " + (disabled || e.disabled ? 'rf-chips__item--disabled' : '') + " " + className + " " + (onClick ? 'rf-chips__item--pointer' : ''), key: e.id, onClick: function (ev) { return handleClick(ev, e); } },
        ...
        onRemove && !disabled && !e.disabled && (react_1.default.createElement("button", { className: 'rf-chips__button', disabled: disabled, onClick: function (ev) { return handleRemove(ev, e.id); } },
