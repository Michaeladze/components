...
var Timepicker = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "rf-timepicker__wrapper " + (className || '') + " " + (disabled ? 'rf-timepicker__disable' : '') },
        react_1.default.createElement(react_input_mask_1.default, { mask: [/[0-2]/, /[0-9]/, ':', /[0-5]/, /[0,5,8]/], value: time, alwaysShowMask: true, readOnly: props.readOnly, onChange: onChange },
        ...
        react_1.default.createElement("div", null,
            react_1.default.createElement(Menu_1.default, { position: 'right', content: content },
                react_1.default.createElement(Button_1.default, { buttonType: 'text', className: 'rf-timepicker__icon' },
