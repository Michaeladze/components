...
var FeedbackPopup = function (_a) {
    var user = _a.user, sendFeedback = _a.sendFeedback, onClose = _a.onClose;
    var _b = react_1.useState(0), rating = _b[0], setRating = _b[1];
    var _c = react_1.useState(''), message = _c[0], setMessage = _c[1];
    var _d = react_1.useState([]), attachment = _d[0], setAttachment = _d[1];
    var stars = [1, 2, 3, 4, 5].map(function (n) { return (react_1.default.createElement("div", { className: "feedback__star " + (n <= rating ? 'feedback__star--active' : ''), key: n, onClick: function () { return setRating(n); } },
    ...
    var onSubmit = function (e) {
        ...
        sendFeedback({
            ...
            file64: ((_a = attachment[0]) === null || _a === void 0 ? void 0 : _a.neutral64) || '',
    ...
    return (react_1.default.createElement("form", { className: 'feedback-popup', onSubmit: onSubmit },
        ...
        react_1.default.createElement("h4", { className: 'feedback-popup__subtitle' }, "\u041F\u043E\u043C\u043E\u0433\u0438\u0442\u0435 \u043D\u0430\u043C \u0441\u0442\u0430\u0442\u044C \u043B\u0443\u0447\u0448\u0435, \u043E\u0446\u0435\u043D\u0438\u0442\u0435 \u0440\u0430\u0431\u043E\u0442\u0443 \u043F\u043E\u0440\u0442\u0430\u043B\u0430."),
        ...
        react_1.default.createElement("div", { className: 'feedback__group' },
            react_1.default.createElement("h3", { className: 'feedback__group-title' }, "\u041F\u043E\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u043E\u0446\u0435\u043D\u043A\u0443"),
            react_1.default.createElement("div", { className: 'feedback__rating' }, stars)),
        react_1.default.createElement("div", { className: 'feedback__group' },
            react_1.default.createElement("h3", { className: 'feedback__group-title' }, "\u0414\u043E\u0431\u0430\u0432\u044C\u0442\u0435 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439"),
        ...
        react_1.default.createElement("div", { className: 'feedback__group' },
            react_1.default.createElement(index_1.FileInput, { name: 'file', buttonType: 'secondary', placeholder: '\u041F\u0440\u0438\u043A\u0440\u0435\u043F\u0438\u0442\u044C \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435', setFile: setFile, accept: 'image/*' })),
        react_1.default.createElement("div", { className: 'feedback__footer' },
            ...
            react_1.default.createElement(index_1.Button, { className: 'feedback__action', buttonType: 'ghost', onClick: onClose }, "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C"))));
};
