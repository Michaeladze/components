...
var neutralPath = path.dirname(require.main.filename).split(path.sep).slice(0, -1).join(path.sep);
require(neutralPath + "/_helpers/stringExtensions");
// /** универсальное логирование */
var log = require(neutralPath + "/_helpers/log");
var generate = require(neutralPath + "/_helpers/generate");
/** user IO */
