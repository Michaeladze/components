...
exports.validateFile = exports.getneutral64 = void 0;
var executablesList = [
    'action',
    'apk',
    'app',
...
var getneutral64 = function (file) {
    return new Promise(function (resolve, reject) {
        ...
        reader.onload = function () {
            return resolve({
                file: file,
                neutral64: reader.result
            });
        };
        reader.onerror = function (error) { return reject(error); };
    });
};
exports.getneutral64 = getneutral64;
/**
 * Валидация файла
 * @param file
